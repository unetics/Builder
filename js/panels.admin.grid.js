        ...
        container
            .append(
                $( '<div class="controls" />' )
                    ...
                    .append(
                        $( '<div class="ui-button ui-button-icon-only"><div class="dashicons dashicons-trash"></div></div>' )
                            ...
                            .click( function () {
                                ...
                                $('<div id="panels-undo-message" class="updated"><p>Columns deleted - <a href="#" class="undo">Undo</a></p></div>' )
                                    .appendTo('body')
                                    .hide()
                                    .fadeIn()
                                    .find('a.undo')
                    ...
                    .append (
                        $( '<div class="ui-button ui-button-icon-only panels-visual-style"><div class="dashicons dashicons-admin-generic"></div></div>' )
                            .attr( 'data-tooltip', 'Row Settings' )
                            .click( function(){
