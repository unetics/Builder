...
( function($){
    ...
    $.fn.panelsCreatePanel = function ( type, data ) {
        ...
        panel.find('.title .actions')
            .append(
                $('<a>' + '<div class="dashicons dashicons-admin-generic"></div>' + '<a>' ).addClass('edit' ).click(function(){
            ...
            .append(
                $('<a>' + '<div class="dashicons dashicons-admin-page"></div>' + '<a>' ).addClass('duplicate' ).click(function(){
            ...
            .append(
                $('<a>' + '<div class="dashicons dashicons-trash"></div>' + '<a>' ).addClass('delete').click(function(){
                    deleteFunction();
                    return false;
                })
            );
